...
namespace taskt.Core.Automation.Commands
{
    ...
    public sealed class BeginIfCommand : ScriptCommand, IHaveDataTableElements, IHaveIfAdditionalCommands
    {
        [XmlAttribute]
        ...
        public override void ConvertToIntermediate(IEngineSettings settings, List<Script.ScriptVariable> variables)
        {
